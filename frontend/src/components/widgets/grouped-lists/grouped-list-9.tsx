...
const reviews = [
  {
    ...
    comment: "Great project, providing an awesome & easy to use product.",
  ...
  },
  {
    ...
    comment:
      "I have been working with this project full-time. Great for the work life balance. Cons, decentralized decision making process across the organization.",
    createdAt: subHours(now, 2).getTime(),
    value: 4,
  },
];
      ...
      >
        ...
        >
          <Typography color="textSecondary" variant="body1">
            Great project, providing an awesome &amp; easy to use product.
          </Typography>
        </Box>
      </Card>
    ))}
