...
const TaskCreate: NextPage = () => {
  ...
  const steps = [
    {
      label: "Category",
      content: <TaskCategoryStep onBack={handleBack} onNext={handleNext} />,
    },
    {
      label: "Task Details",
      content: <TaskDetailsStep onBack={handleBack} onNext={handleNext} />,
    },
    {
      label: "Description",
      content: (
        <TaskDescriptionStep onBack={handleBack} onNext={handleComplete} />
      ),
    },
  ];
